...
public class SaveGame_v120 implements Serializable {
	...
	public boolean DebugGodHull;
	public boolean DebugUnlimitedFuel;
	public boolean DebugEncounterCheats;
	public String  LastTravelEventIntro;
	public boolean TravelDutyStateSaved;
	public int     TravelRepairCrew;
	public int     TravelScannerCrew;
	public int     TravelTargetingCrew;
	public int     TravelTransmissionsCrew;
	public int     EncounterPlayerFleetSize;
	public int     EncounterOpponentFleetSize;
	public int     EncounterOpponentFleetFaction;
	public boolean EncounterFleetPrepared;
	public int     SurveyData;
	public int     SalvageParts;
	public int     AlienRelics;
	public int     ExoticMatter;
	public int     BountyVouchers;
	public int[]   GuildStanding = new int[GameState.MAXGUILD];
	public int     ActiveContractType;
	public int     ActiveContractGuild;
	public int     ActiveContractDestination;
	public int     ActiveContractDeadline;
	public int     ActiveContractReward;
	public int     ActiveContractCargo;
	public int     ActiveContractAmount;
	public int     ActiveContractProgress;
	public int     ActiveContractRequired;
	public int     ScannerLevel;
	public int     MiningRigLevel;
	public int     SalvageDroneLevel;
	...
	public int     CustomCargoDelta;
	public int     CustomHullBonus;
	public int     Credits;
	public int     Debt;
	...
	public SaveGame_v120(GameState g) {
		...
		this.Dragonfly = new SG_v101_Ship(g.Dragonfly.type, g.Dragonfly.cargo.clone(), g.Dragonfly.weapon.clone(),
			g.Dragonfly.shield.clone(), g.Dragonfly.shieldStrength.clone(), g.Dragonfly.gadget.clone(),
			g.Dragonfly.crew.clone(), g.Dragonfly.fuel, g.Dragonfly.hull, g.Dragonfly.tribbles);
		...
		for (i = 0; i < GameState.MAXSOLARSYSTEM; i++) {
			this.SolarSystem[i] = new SG_v101_SolarSystem(g.SolarSystem[i].nameIndex,
				...
				g.SolarSystem[i].visited, g.SolarSystem[i].special, g.SolarSystem[i].dominantSpecies,
				g.SolarSystem[i].controllingGuild, g.SolarSystem[i].conflictLevel, g.SolarSystem[i].economyFocus,
				g.SolarSystem[i].discoveryValue, g.SolarSystem[i].guildInfluence, g.SolarSystem[i].bodies);
		}
		...
		this.LastTravelEventIntro = g.LastTravelEventIntro;
		this.TravelDutyStateSaved = true;
		...
		this.EncounterPlayerFleetSize = g.EncounterPlayerFleetSize;
		this.EncounterOpponentFleetSize = g.EncounterOpponentFleetSize;
		...
		this.GuildStanding = g.GuildStanding == null ? new int[GameState.MAXGUILD] : g.GuildStanding.clone();
		...
		this.ScannerLevel = g.ScannerLevel;
		this.MiningRigLevel = g.MiningRigLevel;
		this.SalvageDroneLevel = g.SalvageDroneLevel;
		this.TradeNetworkLevel = g.TradeNetworkLevel;
	...
	public class SG_v101_SolarSystem implements Serializable {
		...
		public int dominantSpecies;
		public int controllingGuild;
		public int conflictLevel;
		public int economyFocus;
		public int discoveryValue;
		public int[] guildInfluence = new int[GameState.MAXGUILD];
		public StellarBody[] bodies;

		private SG_v101_SolarSystem(int nameIndex, int techLevel, int politics, int status, int x, int y, int specialResources, int size, int[] qty, int countDown, boolean visited, int special, int dominantSpecies, int controllingGuild, int conflictLevel, int economyFocus, int discoveryValue, int[] guildInfluence, StellarBody[] bodies) {
			this.nameIndex = nameIndex;
			...
			this.economyFocus = economyFocus;
			this.discoveryValue = discoveryValue;
			this.guildInfluence = guildInfluence == null ? new int[GameState.MAXGUILD] : guildInfluence.clone();
			this.bodies = bodies == null ? null : bodies.clone();
		}
	}
}
