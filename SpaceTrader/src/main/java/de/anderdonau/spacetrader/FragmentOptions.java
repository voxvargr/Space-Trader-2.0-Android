...
public class FragmentOptions extends MyFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		rootView = inflater.inflate(R.layout.fragment_game_options, container, false);
		CheckBox checkBox;
		...
		checkBox = (CheckBox) rootView.findViewById(R.id.chkBoxDebugEnabled);
		checkBox.setChecked(gameState.DebugEnabled);
	...
	private void refreshSaveButtons() {
		if (rootView == null || main == null) {
			return;
		}
		Button button;
		button = (Button) rootView.findViewById(R.id.btnLoadAutosave);
		button.setEnabled(main.hasAutosave());
		button = (Button) rootView.findViewById(R.id.btnLoadSlot1);
		button.setEnabled(main.hasManualSaveSlot(1));
		button = (Button) rootView.findViewById(R.id.btnLoadSlot2);
		button.setEnabled(main.hasManualSaveSlot(2));
		button = (Button) rootView.findViewById(R.id.btnLoadSlot3);
		button.setEnabled(main.hasManualSaveSlot(3));
	}
